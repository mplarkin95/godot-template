...
const voronoi_material = preload("res://src/Autoload/scenes/transitions/voronoi_material.tres")

@export var loading_screen_scene: PackedScene = preload("res://src/Autoload/scenes/loading/loading_screen.tscn")
